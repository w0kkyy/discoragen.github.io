  ...
  function switchTab(tabName) {
    ...
    const mbnMap = { photos: 'mbnPhotos', videos: 'mbnVideos', games: 'mbnGames', friends: 'mbnFriends', dm: 'mbnDm', newpost: 'mbnNewPost', secrets: 'mbnSecrets' };
  ...
  const mobSunIcon = document.getElementById('mbnSunIcon');
  const mobMoonIcon = document.getElementById('mbnMoonIcon');
