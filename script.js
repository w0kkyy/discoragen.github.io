  ...
  function updateEditAvatarPreview() {
    ...
    box.innerHTML = url ? `<img src="${escapeHtml(url)}" alt="Avatar">` : `<span class="ep-avatar-placeholder">НЕТ ФОТО</span>`;
  }
  ...
  function openUserProfile(userId, fallbackName, fallbackAvatar) {
    ...
    const sortSelectEl = document.getElementById('npProfileSortSelect');
  ...
  window.renderCurrentProfilePosts = function () {
    ...
    const sorted = [...currentProfileUserMsgs].sort((a, b) => {
