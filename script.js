  ...
  function renderReelCard(index) {
    ...
    if (isAlbum) {
      ...
      if (msg.isExternalLink) {
        ...
        mediaHTML = `<div class="reel-media-frame"><div class="reel-media-frame${isNsfwHidden ? ' nsfw-blurred' : ''}" data-nsfw-media="${msg.id}"><img src="${msg.image}" alt="Media" /></div>${isNsfwHidden ? nsfwOverlayHTML(msg.id, false) : ''}</div>`;
      }
    }
